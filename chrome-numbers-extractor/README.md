...
- **תצוגה מקדימה:** כפתור "תצוגה מקדימה" סורק את הדף ומציג טבלה של כל המספרים
  (ערך מקורי מול ערך מנוקה) **בלי לכתוב לשום מקום** — כדי לוודא מה ייכנס לגיליון לפני הרצה.
  שורות שבהן הניקוי שינה את הערך מסומנות בכחול, ומספרים לא תקינים באדום.
